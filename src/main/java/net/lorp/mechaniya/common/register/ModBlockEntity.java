...
public class ModBlockEntity {
    ...
    public static final DeferredHolder<
            BlockEntityType<?>, BlockEntityType<AndesiteControllerBlockEntity>>
            ANDESITE_CONTROLLER_BLOCK_ENTITY =
            BLOCK_ENTITY.register(
                    "andesite_controller",
                    () ->
                            BlockEntityType.Builder.of(
                                            AndesiteControllerBlockEntity::new, ModBlocks.ANDESITE_CONTROLLER.get())
                                    .build(null));
}
