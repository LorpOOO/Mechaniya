...
public class ModItems {
    ...
    public static final DeferredHolder<Item, Item> SHIMMER_BUCKET = ITEMS.register("shimmer_bucket",
    ...
    public static final DeferredHolder<Item, Item> LATEX_BUCKET = ITEMS.register("latex_bucket",
            () -> new BucketItem(ModFluid.SOURCE_LATEX.get(),
                    new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));

    public static final DeferredHolder<Item, BucketItem> WARPED_LATEX_BUCKET = ITEMS.register("warped_latex_bucket",
            () -> new BucketItem(
    ...
    public static final DeferredItem<Item> MINESTAR_LOGO = ITEMS.register("minestar_logo",
            () -> new Item(new Item.Properties()
                    .component(DataComponents.RARITY, Rarity.EPIC)
                    .component(DataComponents.LORE, new ItemLore
                            (List.of(Component.translatable("item.lore_minestar_logo"))))
            ));
    ...
    public static final DeferredItem<Item> ROLL_OF_ROLLS = ITEMS.register(
            "roll_of_rolls",
            () -> new Item(new Item.Properties().food(
                    new FoodProperties.Builder()
                            .nutrition(25) // легке підживлення
                            .saturationModifier(9.9f)
                    ...
                    .component(DataComponents.RARITY, Rarity.EPIC)
                    .component(DataComponents.LORE, new ItemLore
                            (List.of(Component.translatable("item.lore_roll_of_rolls"))))
            )
    );
    ...
    public static final DeferredItem<Item> LEDOK = ITEMS.register(
            "ledok",
            () -> new Item(new Item.Properties().food(
                    new FoodProperties.Builder()
                            .nutrition(25) // легке підживлення
                    ...
                    .component(DataComponents.RARITY, Rarity.RARE)
                    .component(DataComponents.LORE, new ItemLore
                            (List.of(Component.translatable("item.lore_ledok"))))
            )
    );
