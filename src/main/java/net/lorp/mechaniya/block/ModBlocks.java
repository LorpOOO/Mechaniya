...
import static net.lorp.mechaniya.item.ModItems.ITEMS;
...
public class ModBlocks {
    ...
    public static final DeferredHolder<Block, LiquidBlock> SHIMMER_BLOCK = BLOCKS.register("shimmer_block",
            () -> new LiquidBlock(
                    ModFluid.SOURCE_SHIMMER.get(),
    ...
    public static final DeferredHolder<Block, LiquidBlock> LATEX_BLOCK = BLOCKS.register("latex_block",
            () -> new LiquidBlock(
    ...
    public static final DeferredHolder<Block, LiquidBlock> WARPED_LATEX_BLOCK = BLOCKS.register("warped_latex_block",
            () -> new LiquidBlock(
                    ModFluid.SOURCE_WARPED_LATEX.get(), // Перевірте, щоб тут було саме SOURCE
                    BlockBehaviour.Properties.of()
                            .mapColor(MapColor.WATER)
                            .noCollission()
                            .strength(100.0F)
